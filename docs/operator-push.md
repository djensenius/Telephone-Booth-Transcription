...
where there is no worker, a single _Draft with Apple Intelligence_ runs the whole
review on-device — transcribe, translate, and moderate — and one _Submit_ posts
